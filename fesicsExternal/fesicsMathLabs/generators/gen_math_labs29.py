...
LABS = [
    ("hp_repetition_lab_ProbStat_Perm_Ep03.html",
     "뽑기 방식 실험실 — 중복과 순서가 무엇을 바꿀까?",
     "뽑기 방식 실험실 — 중복과 순서가 무엇을 바꿀까?",
     "세 가지 방식으로 모든 경우를 나열해 세고, n^r·nPr·nCr과 대조한다.",
     LAB_REP),
    ("hp_pascal_lab_ProbStat_RepComb_Ep05.html",
    ...
    ("hp_conditional_probability_lab_ProbStat_CondProb_Ep01.html",
     ...
     LAB_COND),
    ("hp_independence_lab_ProbStat_Prob_Ep05.html",
     "독립·배반 실험실 — 배반이면 독립일까?",
     "독립·배반 실험실 — 배반이면 독립일까?",
     "네 칸의 인원을 바꿔 가며 독립 조건과 배반 조건이 각각 언제 성립하는지 기록한다.",
     LAB_INDEP),
    ("hp_expected_value_lab_ProbStat_Dist_Ep03.html",
